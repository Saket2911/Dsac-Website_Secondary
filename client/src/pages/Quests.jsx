  ...
  return <div className="py-10 space-y-10 animate-in fade-in duration-500">
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          icon: "🟢",
          desc: "Build robust APIs and server-side applications.",
          xp: 600,
          tag: "Backend"
        }, {
          title: "Database Design",
          icon: "🗄️",
          desc: "Learn SQL, MongoDB, and schema design principles.",
          xp: 450,
          tag: "Backend"
        }, {
          title: "Algorithms 101",
          icon: "🧠",
          desc: "Sorting, searching, and fundamental algorithms.",
          xp: 800,
          tag: "DSA"
        }, {
          title: "Data Structures",
          icon: "📚",
          desc: "Arrays, LinkedLists, Trees, and Graphs.",
          xp: 800,
          tag: "DSA"
        }].map((quest, i) => <Card key={i} className="border-border/50 shadow-sm hover:shadow-md transition-all duration-300 group flex flex-col">
