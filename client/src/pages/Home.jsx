...
export default function Home() {
  return <div className="flex flex-col pb-20">
      ...
      <section className="py-20">
        ...
        }].map((feature, idx) => <div key={idx} className="bg-card/50 border border-border/50 rounded-2xl p-8 hover:bg-card hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
